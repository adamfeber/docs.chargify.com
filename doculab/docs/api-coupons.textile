...
Response: If the coupon is successfully removed, The string Coupon Remove will be returned verifying the coupon has been removed. Otherwise, a '422 Uprocessable Entity' error will be returned.
